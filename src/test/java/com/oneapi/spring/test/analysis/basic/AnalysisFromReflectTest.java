...
public class AnalysisFromReflectTest {
    ...
    public void sourceJARExist() throws IOException {
        ...
        Mockito.when(reflectCache.getCache(Mockito.any())).thenReturn(TestUtil.getBaseDir() + "com/oneapi/spring/testSuite/guice-4.2.3.jar");
        
        // 复制并重命名 guice-4.2.3.jar 为 guice-4.2.3-sources.jar
        File jarFile = new File(TestUtil.getBaseDir() + "com/oneapi/spring/testSuite/guice-4.2.3.jar");
        File sourceJarFile = new File(TestUtil.getBaseDir() + "com/oneapi/spring/testSuite/guice-4.2.3-sources.jar");
        ...
        Assertions.assertNull(classModel);
        // 断言 unzip 参数
        String unzipKey = TestUtil.getBaseDir() + "com/oneapi/spring/testSuite/guice-4.2.3-sources.jar";
        Assertions.assertEquals(unZipArgs.get(unzipKey), TestUtil.getBaseDir() + "com/oneapi/spring/testSuite/source");
        
        // 断言 saveResource 参数
        Assertions.assertFalse(resourceArgs.get(TestUtil.getBaseDir() + "com/oneapi/spring/testSuite/source"));
    ...
    public void notInSourceJAR() {
        ...
        File deCompileDir = new File(TestUtil.getBaseDir() + "com/oneapi/spring/testSuite/deCompile");
        ...
        // 断言解压参数
        String unzipKey = TestUtil.getBaseDir() + "com/oneapi/spring/testSuite";
